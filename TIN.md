...
## 2.TIN模型部署
### 论文链接：
-[CVPR2019版本](https://arxiv.org/abs/1811.08264)

-[TPAMI2021版本](https://arxiv.org/abs/2101.10292)

### 代码链接：
-[CVPR2019版本](https://github.com/DirtyHarryLYL/Transferable-Interactiveness-Network)

-[TPAMI版本](https://github.com/DirtyHarryLYL/Transferable-Interactiveness-Network/tree/TIN-PAMI)


### 数据集链接：
-[V-COCO Dataset](https://github.com/s-gupta/v-coco.git)
-[HICO-DET Dataset](https://drive.google.com/open?id=1QZcJmGVlF9f4h-XLWe9Gkmnmj2z1gSnk)

下载Github[项目代码](https://github.com/DirtyHarryLYL/Transferable-Interactiveness-Network/tree/TIN-PAMI)后可直接使用数据下载命令行
```
...
### 模型主要功能
该模型主要用来预测人与物体是否发生交互，二分类任务。

其可以进一步降解为，人的10个身体部位是否和物体发生交互。因为人与物体交互等价于人存在一个身体部位与该物体交互。
...
代码地址：https://github.com/DirtyHarryLYL/Transferable-Interactiveness-Network/blob/TIN-PAMI/lib/models/test_Solver_HICO_DET_binary.py

2. TIN模型流程（TPAMI版本）

输入image -> 检测器detector (human + objects) -> 对human检测框提取10个body part的特征 -> 对每个body part与物体的交互做二分类预测 -> 得到最终human与物体的交互二分类 -> 预测human的行为

代码位置：https://github.com/DirtyHarryLYL/Transferable-Interactiveness-Network/blob/TIN-PAMI/lib/networks/TIN_HICO_with_part.py
