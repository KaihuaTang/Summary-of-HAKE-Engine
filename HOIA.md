## 5.HOI Analysis模型部署
### 论文链接：
-[NeurIPS2020版本](https://arxiv.org/abs/2010.16219)

### 代码链接：
-[pytorch代码](https://github.com/DirtyHarryLYL/HAKE-Action-Torch/tree/IDN-(Integrating-Decomposing-Network))
...
### 主要模块：
注意，该模型直接使用预先提取的Faster RCNN检测框特征，因此模型的输入直接为物体特征与人特征，而非传统的图片。

代码位置：https://github.com/DirtyHarryLYL/HAKE-Action-Torch/blob/IDN-(Integrating-Decomposing-Network)/model.py
```
import torch
